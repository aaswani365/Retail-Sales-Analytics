...
Module          : 23_Executive_KPIs.sql
Description     : Executive Dashboard KPIs for Business Performance Analysis
...
Total KPIs      : 45
Difficulty      : Beginner → Intermediate SQL
...
Part 2             : Revenue KPIs
Part 3             : Order KPIs
Part 4             : Customer KPIs
Part 5             : Sales Performance KPIs
...
PRINT '==============================================================';
PRINT 'Part 1 : Business Overview';
PRINT '==============================================================';
...
PRINT '==============================================================';
PRINT 'Part 5 : Sales Performance KPIs';
PRINT '==============================================================';
...
SELECT
    ...
    CAST
    (
        SUM(O.NetAmount) * 100.0 / SUM(SUM(O.NetAmount)) OVER () AS DECIMAL(6,2)
...
PRINT '==============================================================';
PRINT '23_Executive_KPIs.sql Completed Successfully';
PRINT '==============================================================';

PRINT 'Module Name       : Executive KPIs';
PRINT 'Total KPIs        : 45';
PRINT 'Database          : RetailSalesDB';
PRINT 'Execution Status  : SUCCESS';
PRINT 'Module Version    : 1.0';
